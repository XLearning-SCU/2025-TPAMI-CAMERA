...
import collections
import torch
from model_classify import CAMERA
from util import get_logger,cal_classify
...
def main():
    ...
    for data_seed in range(0, args.test_time):
        ...
        acc, precision, f_measure,test_train_time = model.train(args, config, train_loader, eval_train_loader, index_loader,eval_test_loader, logger,accumulated_metrics , optimizer, device)
