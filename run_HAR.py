...
import collections
import torch
from model_HAR import CAMERA
from util import get_logger, cal_HAR
from datasets_classify import *
...
parser.add_argument('--sup_lambda', type=float, default=5.0)
...
def main():
    ...
    for data_seed in range(0, args.test_time):
        ...
        train_loader, eval_train_loader, index_loader,eval_test_loader, class_num = get_dataloader(args=args, aligned_prop=args.aligned_prop, complete_prop=args.complete_prop)
        ...
        rgb, depth, rgb_depth, onlyrgb, onlydepth,test_train_time = model.train(args, config, train_loader, eval_train_loader, index_loader,eval_test_loader, logger,accumulated_metrics , optimizer, device)
